...
def test_deploy_agent_includes_active_room_id():
    set_active_room("e522ea0a-4d46-4279-a14d-36ecf5b97f06")
    spawn_result = {"status": "deployed", "pid": 99, "name": "planner"}
    ...
    assert payload["room_id"] == "e522ea0a-4d46-4279-a14d-36ecf5b97f06"
    assert "e522ea0a" in payload["next_step"]
